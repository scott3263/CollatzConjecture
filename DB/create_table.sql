...
select max(seq) from Collatz_Conjecture;

select max(bounce) from Collatz_Conjecture;

select max(max_num) from Collatz_Conjecture;

select max(reg_date) from Collatz_Conjecture;
